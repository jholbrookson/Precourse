...
function isEven(num) {
  ...
  return false; // return true if num is even  // otherwise return false// code here
}
...
function getGreeting(name) {
  let i = 'Hello ';
  return i + name + '!'; // Take the name string and concatenate other strings onto it so it takes the following form:
  // 'Sam' -> 'Hello Sam!'
  // code here
}
...
function getCircleArea(radius) {
  return Math.round(3.14 * Math.pow(radius, 2)); // return the rounded area of the circle given the radius
  // code here
}
